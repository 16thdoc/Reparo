...
4. Review `git status` and `git diff` for the source, generated artifacts, and docs.
5. Commit the coherent release change, push it, and verify the remote-tracking state.
6. Pilot the normal deployment artifact before broad fleet rollout.

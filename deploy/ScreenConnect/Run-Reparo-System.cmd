...
echo Starting Reparo SYSTEM task...
...
echo Reparo %REPARO_ARGS% started as SYSTEM.
echo Check logs under C:\ProgramData\Reparo\Logs
echo Useful checks:
echo   powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT%" -Status
echo   powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT%" -Tail
